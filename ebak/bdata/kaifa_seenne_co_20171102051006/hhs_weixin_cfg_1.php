...
E_D("replace into `hhs_weixin_cfg` values('1','murl','http://kaifa.seenne.com/index.php','yes');");
E_D("replace into `hhs_weixin_cfg` values('2','baseurl','http://kaifa.seenne.com/index.php','yes');");
